    ...
    {scale:0 ,opacity: 0},
    {
        ...
        onComplete: () => {
            gsap.to(greeting, {
                ...
                yoyo: true,
                ease: "power1.inOut",
                textShadow: "0 0 20px #ffcc00, 0 0 30px #ff9900",
            });
        }
    }
);
...
var colors=['#ff5252', '#ff4081', '#e040fb', '#7c4dff', '#53dff', '#18ffff', '#64ffda', '#69f0ae', '#b2fff59'];
...
function Run(){
    ...
    for(let ix in pass){
        ...
        ctx.beginPath();
        ctx.arc(pas.x, pas.y, pas.size, 0, 1.5 * Math.PI);
